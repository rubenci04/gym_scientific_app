...
class RoutineDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Acceso al tema y a la caja de ejercicios para buscar nombres reales
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ExpansionTile(
                    shape: Border.all(color: Colors.transparent), // Quita bordes feos al expandir
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ...day.exercises.map((routineExercise) {
                              // Buscamos el objeto Exercise real para tener el nombre bonito
